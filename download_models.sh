...
wget -O cfg/voc.names https://public-model.s3-ap-southeast-1.amazonaws.com/voc.names
...
wget -O weights/voc.names https://public-model.s3-ap-southeast-1.amazonaws.com/voc.names
